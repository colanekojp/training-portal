...
const LEADERBOARD_CACHE_KEY = 'n2-leaderboard-cache-v4';
...
const DEMO_ROWS = [
  { rank: 1, studentId: 'N2001', grammar: 4, listening: 2, tutoring: 4, vocabulary: 3, assistantBonus: 2, total: 15 },
  { rank: 2, studentId: 'N2008', grammar: 4, listening: 2, tutoring: 3, vocabulary: 2, assistantBonus: 1, total: 12 },
  { rank: 3, studentId: 'N2005', grammar: 3, listening: 1, tutoring: 4, vocabulary: 2, assistantBonus: 1, total: 11 },
  { rank: 4, studentId: 'N2002', grammar: 3, listening: 1, tutoring: 3, vocabulary: 1, assistantBonus: 1, total: 9 }
];
...
async function loadLeaderboard(keepCurrentContent = false) {
  ...
  try {
    ...
    url.search = new URLSearchParams({ action: 'portal', level: 'N2', include_leaderboard: '1' }).toString();
