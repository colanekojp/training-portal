...
const LEADERBOARD_CACHE_KEY = 'n1-leaderboard-cache-v4';
...
const DEMO_ROWS = [
  { rank: 1, studentId: 'N1001', grammar: 4, listening: 2, tutoring: 4, vocabulary: 3, assistantBonus: 2, total: 15 },
  { rank: 2, studentId: 'N1008', grammar: 4, listening: 2, tutoring: 3, vocabulary: 2, assistantBonus: 1, total: 12 },
  { rank: 3, studentId: 'N1005', grammar: 3, listening: 1, tutoring: 4, vocabulary: 2, assistantBonus: 1, total: 11 },
  { rank: 4, studentId: 'N1002', grammar: 3, listening: 1, tutoring: 3, vocabulary: 1, assistantBonus: 1, total: 9 }
];
...
async function loadLeaderboard(keepCurrentContent = false) {
  ...
  try {
    ...
    url.search = new URLSearchParams({ action: 'portal', level: 'N1', include_leaderboard: '1' }).toString();
